...
public class DebugMessage extends Message {
  ...
  /** GetProperty */
  public java.lang.Boolean getIsAlwaysDisplay() {
    try {
      java.lang.Boolean res = javonetHandle.get("IsAlwaysDisplay");
  ...
  public DebugMessage() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Renci.SshNet.Messages.Transport.DebugMessage");
  ...
  public DebugMessage(NObject handle) {
    super(handle);
