...
public class IgnoreMessage extends Message {
  ...
  public IgnoreMessage() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Renci.SshNet.Messages.Transport.IgnoreMessage");
  ...
  public IgnoreMessage(java.lang.Byte[] data) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("Renci.SshNet.Messages.Transport.IgnoreMessage", new Object[] {data});
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public IgnoreMessage(NObject handle) {
    super(handle);
