...
public abstract class AuthenticationMethod {
  ...
  public IEnumerable<java.lang.String> getAllowedAuthentications() {
    try {
      Object res =
          javonetHandle
              .explicitInterface("Renci.SshNet.IAuthenticationMethod")
              .invoke("get_AllowedAuthentications");
  ...
  public AuthenticationMethod(NObject handle) {
