...
public class SHA384Hash extends SHA2HashBase implements IDisposable, ICryptoTransform {
  ...
  public SHA384Hash() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Renci.SshNet.Security.Cryptography.SHA384Hash");
  ...
  public SHA384Hash(NObject handle) {
    super(handle);
