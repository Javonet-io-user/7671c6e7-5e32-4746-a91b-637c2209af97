...
public class MD5Hash extends HashAlgorithm implements IDisposable, ICryptoTransform {
  ...
  public MD5Hash() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Renci.SshNet.Security.Cryptography.MD5Hash");
