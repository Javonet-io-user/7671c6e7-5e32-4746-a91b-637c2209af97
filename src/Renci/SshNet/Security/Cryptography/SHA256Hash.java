...
public class SHA256Hash extends HashAlgorithm implements IDisposable, ICryptoTransform {
  ...
  public SHA256Hash() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Renci.SshNet.Security.Cryptography.SHA256Hash");
  ...
  public SHA256Hash(NObject handle) {
    super(handle);
