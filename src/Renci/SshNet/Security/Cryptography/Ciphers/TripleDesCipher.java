...
public class TripleDesCipher extends DesCipher {
  protected NObject javonetHandle;

  public TripleDesCipher(java.lang.Byte[] key, CipherMode mode, CipherPadding padding) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New(
  ...
  public TripleDesCipher(NObject handle) {
    super(handle);
