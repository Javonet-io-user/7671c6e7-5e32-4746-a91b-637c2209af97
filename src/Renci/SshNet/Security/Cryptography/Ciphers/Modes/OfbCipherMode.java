...
import Renci.SshNet.Security.Cryptography.Ciphers.Modes.*;

public class OfbCipherMode extends CipherMode {
  protected NObject javonetHandle;

  public OfbCipherMode(java.lang.Byte[] iv) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New(
              "Renci.SshNet.Security.Cryptography.Ciphers.Modes.OfbCipherMode", new Object[] {iv});
  ...
  public OfbCipherMode(NObject handle) {
    super(handle);
