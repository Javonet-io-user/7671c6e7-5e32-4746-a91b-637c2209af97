...
public class CfbCipherMode extends CipherMode {
  protected NObject javonetHandle;

  public CfbCipherMode(java.lang.Byte[] iv) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New(
              "Renci.SshNet.Security.Cryptography.Ciphers.Modes.CfbCipherMode", new Object[] {iv});
  ...
  public CfbCipherMode(NObject handle) {
    super(handle);
