...
public class CbcCipherMode extends CipherMode {
  protected NObject javonetHandle;

  public CbcCipherMode(java.lang.Byte[] iv) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New(
              "Renci.SshNet.Security.Cryptography.Ciphers.Modes.CbcCipherMode", new Object[] {iv});
  ...
  public CbcCipherMode(NObject handle) {
    super(handle);
