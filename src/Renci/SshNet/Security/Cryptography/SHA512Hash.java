...
public class SHA512Hash extends SHA2HashBase implements IDisposable, ICryptoTransform {
  ...
  public SHA512Hash() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Renci.SshNet.Security.Cryptography.SHA512Hash");
  ...
  public SHA512Hash(NObject handle) {
    super(handle);
