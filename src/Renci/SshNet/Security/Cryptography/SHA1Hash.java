...
public class SHA1Hash extends HashAlgorithm implements IDisposable, ICryptoTransform {
  ...
  public SHA1Hash() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Renci.SshNet.Security.Cryptography.SHA1Hash");
  ...
  public SHA1Hash(NObject handle) {
    super(handle);
