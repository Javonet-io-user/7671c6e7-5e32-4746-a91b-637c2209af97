...
public abstract class KeyExchangeDiffieHellmanGroupSha1 extends KeyExchangeDiffieHellman
    implements IKeyExchange, IDisposable {
  protected NObject javonetHandle;
  /** GetProperty */
  public BigInteger getGroupPrime() {
    try {
  ...
  public KeyExchangeDiffieHellmanGroupSha1(NObject handle) {
    super(handle);
