...
public class SftpSynchronizeDirectoriesAsyncResult extends AsyncResultTResult<IEnumerable<FileInfo>>
  ...
  public SftpSynchronizeDirectoriesAsyncResult(AsyncCallback asyncCallback, Object state) {
    ...
    try {
      javonetHandle =
          Javonet.New(
              "Renci.SshNet.Sftp.SftpSynchronizeDirectoriesAsyncResult", asyncCallback, state);
  ...
  public SftpSynchronizeDirectoriesAsyncResult(NObject handle) {
    super(handle);
